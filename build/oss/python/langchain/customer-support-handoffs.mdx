...
- [Middleware](/oss/python/langchain/middleware) for dynamic agent configuration
- [Tools](/oss/python/langchain/tools) for state management
- [Short-term memory](/oss/python/langchain/short-term-memory) for state persistence
...
Use **[supervisor](/oss/python/langchain/supervisor)** when:
