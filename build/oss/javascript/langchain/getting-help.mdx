...
- **[LangChain Academy](https://academy.langchain.com/)** – Interactive courses and hands-on tutorials
- **[Tutorials](https://docs.langchain.com/oss/python/learn)** – Step-by-step guides for common use cases
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit the source of this page on GitHub.](https://github.com/langchain-ai/docs/edit/main/src/oss/langchain/getting-help.mdx)
</Callout>
